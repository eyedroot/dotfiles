...
- `~/.local/bin/laratail` - Kubernetes Laravel log tailer TUI (fzf-based cluster/namespace/pod picker, in-container log file tailing with syntax highlight; requires `fzf`, `kubectl`)
